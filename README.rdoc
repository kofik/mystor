...
* Steps for new git user
	...
	git tag -a 0.0.1 -m "Release of version 0.0.1"
	git push --tags

	git checkout -b spreeTwilio
	git commit -am 'Adding SMS feature'
	git push origin spreeTwilio
...
*Docs
Please feel free to use a different markup language if you do not plan to run_
	rake doc:app
...
It performs docgen twice my task and original rake doc:app
